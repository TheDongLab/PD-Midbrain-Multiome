# =============================================================================
# Step 10 - Peak-gene enhancer linking with scMultiMap
# -----------------------------------------------------------------------------
...
saveRDS(link_results2, file.path(out_dir, "scMultiMap_peak_gene_results2.rds"))
saveRDS(link_results_sig2, file.path(out_dir, "scMultiMap_peak_gene_results_sig2.rds"))
