# =============================================================================
#  caQTL preprocessing and cis-mapping inputs (FastQTL)
# -----------------------------------------------------------------------------
...
# conda create --name peer python=3.5.5
# conda activate peer
...
# Permutation : fastQTL.static --vcf VCF --bed BED --cov COV --out PERM --window 1e6 --permute 1000 10000--region chrN
